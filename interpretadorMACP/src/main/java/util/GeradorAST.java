...
class GeradorAST {
	...
	public static void main(String[] args) throws IOException {
		...
		defineAst(path, "Expressao", Arrays.asList(
				...
				"Binario   : Expressao esquerda, Token operador, Expressao direita", "Grupo     : Expressao expressao",
				"ExpParentizada : Grupo grupo", "Literal  : Object valor",
				"Logico  : Expressao esquerda, Token operador, Expressao direita",
				"Unario    : Token operador, Expressao direira", "Atribuicao: Token nome, Expressao valor",
				"AtribuicaoArray: Token nome, Expressao index, Expressao valor",
				"VariavelArray: Token nome, Expressao index", "Variavel : Token nome"));
		defineAst(path, "Declaracao", Arrays.asList("Bloco :  List<Declaracao> declaracoes",
				"Expressao : tree.Expressao expressao", "Escreva      :  List<tree.Expressao> expressoes",
				"Se         : tree.Expressao condicao, Bloco entaoBloco, Bloco senaoBloco",
				"Ler      : tree.Expressao atribuicao", "Var      : Token nome, Token tipo",
				...
				"Enquanto      : tree.Expressao condicao, Bloco corpo", "Repita:  Bloco corpo, tree.Expressao condicao",
				"Modulo: Token nome, Bloco corpo", "ChamadaModulo: Token identificador",
