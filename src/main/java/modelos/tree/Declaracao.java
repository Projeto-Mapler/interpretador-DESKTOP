...
public abstract class Declaracao extends AstDebugNode {
	...
	public static class VariavelArray extends Declaracao {
		public VariavelArray(int linha, Token nome, modelos.tree.Expressao intervaloI,
				modelos.tree.Expressao intervaloF, Token tipo) {
			super(linha);
			this.nome = nome;
	...
	public static class Para extends Declaracao {
		public Para(int linha, modelos.tree.Expressao atribuicao, modelos.tree.Expressao condicao,
				modelos.tree.Expressao incremento, Bloco facaBloco) {
			super(linha);
			this.atribuicao = atribuicao;
			this.condicao = condicao;
