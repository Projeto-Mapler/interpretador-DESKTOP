...
public class ConversorPascal extends Conversor implements Expressao.Visitor<Void>, Declaracao.Visitor<Void> {
	...
	escritor.concatenarNaLinha(" then").addQuebraLinha().concatenarNaLinha("begin").addQuebraLinha().indentar();
	...
	escritor.concatenarNaLinha("else").addQuebraLinha().concatenarNaLinha("begin").addQuebraLinha().indentar();
	...
	escritor
		.concatenarNaLinha(
				   declaracao.nome.lexeme + " : array[" + vv.getIntervaloI() + ".." + vv.getIntervaloF()
					   + "] of " + tipo + ";")
		.addQuebraLinha();
	...
	escritor.concatenarNaLinha("do").addQuebraLinha().concatenarNaLinha("begin").addQuebraLinha().indentar();
