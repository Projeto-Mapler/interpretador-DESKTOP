...
/**
 * Base para Classes conversoras para outras linguagens Classes conversoras devem implementar as
 * Interfaces Visitor para Declaração e Expressao também.
 * 
 * @author Kerlyson
 *
 */
public abstract class Conversor {
  ...
  public Conversor(Programa programa, EventosService ge) {
